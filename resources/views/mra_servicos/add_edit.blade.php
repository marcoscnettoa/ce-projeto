...
@section('content')
    ...
    {!! Form::open(['url' => "mra_nota_fiscal/mra_servicos".($acao=='edit'?'/'.$MRANfServicos->id:''), 'method' => ($acao=='edit'?'put':'post'), 'novalidate'=> true, 'enctype' => 'multipart/form-data', 'accept-charset' => 'utf-8', 'id' => ($acao=='edit'?'form_edit':'form_add').'_mra_servicos']) !!}
            ...
            @if($acao=='edit')
                ...
                @if(\App\Models\Permissions::permissaoUsuario(\Auth::user(), "$controller@destroy"))
                    <div class="row" style="position: absolute; right: 0; padding: 5px; z-index: 100;">
                        <div class="col-md-12">
                            <a href="javascript:void(0);" type="button" class="btn btn-danger excluir-auto-confirma" modulo="mra_nota_fiscal/mra_servicos" modulo_id="{{$MRANfServicos->id}}"><i class="glyphicon glyphicon-trash"></i></a>
                        </div>
                    </div>
                @endif
            @endif
            <div class="box-body" id="div_mra_servicos">
                    ...
                    <div class="row">
                        <div size="12" class="inputbox col-md-12">
                            <div class="form-group">
                                ...
                                {!! Form::select('imp_atividade_cnae', \App\Http\Controllers\MRA\MRANotasFiscais::Get_options_nf_cnae_23(), ($acao=='edit'?$MRANfServicos->imp_atividade_cnae:null), ['class' => 'form-control select_single_no_trigger bootstrap-select-st2', 'data-live-search' => 'true', "dropdown-menu-right"=>"", "id" => "input_imp_atividade_cnae"]) !!}
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div size="12" class="inputbox col-md-12">
                            <div class="form-group">
                                ...
                                <select id="input_imp_servico_lc116" name="imp_servico_lc116" class="form-control select_single_no_trigger bootstrap-select-st2" data-live-search="true">
                                    {!! App\Http\Controllers\MRA\MRANotasFiscais::Get_options_nf_servicos_lc116($imp_servico_lc116) !!}
                                </select>
                            </div>
                        </div>
                    </div>
