    ...
    <section class="content">
        {{--@if($exibe_filtros)--}}
                ...
                <div class="row">
                    <div class="col-md-2">
                        <div class="small-box v2 bg-default">
                            <div class="inner" style="color: #000;">
                                <h3>{{ \App\Models\MRANfNfse::Get_QtStatus_Null() }}</h3>
                                <p>Salvos</p>
                    ...
                    <div class="col-md-2">
                        <div class="small-box v2 bg-info">
                            <div class="inner" style="color: #000;">
                                <h3>{{ \App\Models\MRANfNfse::Get_QtStatus_Pendente() }}</h3>
                                <p>Pendentes</p>
                    ...
                    <div class="col-md-2">
                        <div class="small-box v2 bg-success">
                            <div class="inner" style="color: #000;">
                                <h3>{{ \App\Models\MRANfNfse::Get_QtStatus_Autorizada() }}</h3>
                                <p>Autorizadas</p>
                    ...
                    <div class="col-md-2">
                        <div class="small-box v2 bg-warning">
                            <div class="inner" style="color: #000;">
                                @php
                                    $autorizando_cancelando  = \App\Models\MRANfNfse::Get_QtStatus_AguardandoAutorizacao();
                                    $autorizando_cancelando += \App\Models\MRANfNfse::Get_QtStatus_EmProcessoDeCancelamento();
                                    $autorizando_cancelando += \App\Models\MRANfNfse::Get_QtStatus_AguardandoCancelamento();
                                @endphp
                    ...
                    <div class="col-md-2">
                        <div class="small-box v2 bg-danger">
                            <div class="inner" style="color: #000;">
                                <h3>{{ \App\Models\MRANfNfse::Get_QtStatus_Rejeitada() }}</h3>
                                <p>Rejeitadas</p>
                    ...
                    <div class="col-md-2">
                        <div class="small-box v2 bg-danger">
                            <div class="inner" style="color: #000;">
                                <h3>{{ \App\Models\MRANfNfse::Get_QtStatus_Cancelada() }}</h3>
                                <p>Canceladas</p>
            ...
            <div class="box-header" style="background-color: #fff; padding-top: 30px">
                <form action="{{ URL('/') }}/mra_nota_fiscal/mra_nfs_e/filter" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div size="3" class="inputbox col-md-3">
                            <div class="form-group">
                                {!! Form::label('','Serviço') !!}
                                {!! Form::select('mra_nf_prod_serv_id', \App\Models\MRANfServicos::lista_servicos(), (Request::get('mra_nf_prod_serv_id')?Request::get('mra_nf_prod_serv_id'):null), ['class' => 'form-control select_single_no_trigger', 'data-live-search' => 'true', 'id' => 'input_mra_nf_prod_serv_id']) !!}
                            </div>
                        </div>
                        <div size="3" class="inputbox col-md-3">
                            <div class="form-group">
                        ...
                        <div size="3" class="inputbox col-md-3">
                            <div class="form-group">
                                ...
                                {!! Form::select('tomador', \App\Http\Controllers\MRA\MRANotasFiscais::Get_options_nfs_e_tomador(), (Request::get('tomador')?Request::get('tomador'):null), ['class' => 'form-control select_single_no_trigger', 'data-live-search' => 'true', 'id' => 'input_cliente_tomador']) !!}
                            </div>
                        </div>
                        <div size="3" class="inputbox col-md-3">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-3 btnsFiltro">
                            <a href="{{ URL('/mra_nota_fiscal/mra_nfs_e') }}" class="btn btn-default" style="float: left; margin-right: 5px;"><i class="glyphicon glyphicon-trash"></i> Limpar</a>
            ...
            <div class="box-body table-responsive">
                ...
                <table id="<?php echo (!$export_enable_btns ? 'datatable-no-buttons' : 'datatable'); ?>" class="display table-striped table-bordered stripe" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th style="white-space: nowrap;">Serviço</th>
                            <th style="white-space: nowrap;">Cliente/Tomador</th>
                            <th style="white-space: nowrap;">Com Tomador</th>
                    ...
                    <tbody>
                        @foreach($MRANfNfse as $value)
                            <tr>
                                ...
                                @php
                                    $servico = '---';
                                    if($value->Servico and !empty($value->Servico->nome)) {
                                        $servico = $value->Servico->nome;
                                    }elseif(!empty($value->cfg_desc_servico_municipio)){
                                        $servico = $value->cfg_desc_servico_municipio;
                                    }
                                @endphp
                                <td style="white-space: nowrap;">{{ $servico }}</td>
                                @php
                                    $cliente = '---';
                                ...
                                <td style="white-space: nowrap;">{!! ($value->tomador?"<span class='badge badge-success fw-600'>Sim</span>":"<span class='badge badge-danger fw-600'>Não</span>")!!}</td>
                                ...
                                <td style="white-space: nowrap;">{{((in_array($value->notazz_status,['Autorizada']) and !empty($value->nf_codigoVerificacao))?$value->nf_codigoVerificacao:'---')}}</td>
                                ...
                                @if(
                                    ...
                                    @if(!empty($value->nf_pdf_prefeitura))
                                        @php
                                            // # Fix *
                                            if(!(strpos($value->nf_pdf_prefeitura, '&nf=') !== false)){ $value->nf_pdf_prefeitura.= '&nf='.$value->nf_numero; }
                                            if(!(strpos($value->nf_pdf_prefeitura, '&verificacao=') !== false)){ $value->nf_pdf_prefeitura.= '&verificacao='.$value->nf_codigoVerificacao; }
                                            // - #
                                        @endphp
                                ...
                                @if($auth_user__actions_enable_btns)
                                    <td>
                                        @if($permissaoUsuario_auth_user__controller_update)
                                            <a style="float: left; margin-right: 5px;" href="{{ URL('/') }}/mra_nota_fiscal/mra_nfs_e/{{$value->id}}/edit" alt="Editar" title="Editar" class="btn btn-default">
                                                <span class="glyphicon glyphicon-edit"></span>
                                            </a>
                                        @endif
                                        {{--@if(0)
                                            @if($permissaoUsuario_auth_user__controller_copy)
                                                <a style="float: left; margin-right: 5px;" href="{{ URL('/') }}/mra_nota_fiscal/mra_nfs_e/{{$value->id}}/copy" alt="Duplicar linha" title="Duplicar linha" class="btn btn-default" onclick="return confirm('Tem certeza que quer duplicar a linha?')" >
                                                    <span class="glyphicon glyphicon-copy"></span>
                                                </a>
                                            @endif
                                        @endif--}}
                                        {{--@if($permissaoUsuario_auth_user__controller_show)
                                            <a style="float: left; margin-right: 5px;" href="{{ URL('/') }}/mra_nota_fiscal/mra_nfs_e/{{$value->id}}" alt="Visualizar" title="Visualizar" class="btn btn-default">
                                                <span class="glyphicon glyphicon-eye-open"></span>
                                            </a>
                                        @endif--}}
                                        @if($permissaoUsuario_auth_user__controller_destroy and empty($value->notazz_id_documento))
                                            <form style="float: left; margin-right: 5px;" method="POST" action="{{ route('mra_nfs_e.destroy', $value->id) }}" accept-charset="UTF-8">
                                                {!! csrf_field() !!}
                                                {!! method_field('DELETE') !!}
                                        ...
                                        @if($config_empresa_token_api and $permissaoUsuario_auth_user__controller_destroy and in_array($value->notazz_status,['Autorizada']))
                                            <form style="float: left; margin-right: 5px;" method="POST" action="{{ URL('/') }}/mra_nota_fiscal/mra_nfs_e/{{$value->id}}" accept-charset="UTF-8">
                                                {!! csrf_field() !!}
                                                {!! method_field('PUT') !!}
                ...
                <div class="form-group form-group-btn-index">
                    ...
                    @if(\App\Models\Permissions::permissaoUsuario(\Auth::user(), "$controller@store"))
                        <a href="{{ URL('/') }}/mra_nota_fiscal/mra_nfs_e/create" class="btn btn-default right form-group-btn-index-cadastrar"><i class="glyphicon glyphicon-plus"></i> Cadastrar</a>
                    @endif
                </div>
            </div>
        </div>
