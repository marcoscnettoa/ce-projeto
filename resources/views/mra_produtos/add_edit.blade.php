...
@section('content')
    ...
    {!! Form::open(['url' => "mra_nota_fiscal/mra_produtos".($acao=='edit'?'/'.$MRANfProdutos->id:''), 'method' => ($acao=='edit'?'put':'post'), 'novalidate'=> true, 'enctype' => 'multipart/form-data', 'accept-charset' => 'utf-8', 'id' => ($acao=='edit'?'form_edit':'form_add').'_mra_produtos']) !!}
            ...
            @if($acao=='edit')
                ...
                @if(\App\Models\Permissions::permissaoUsuario(\Auth::user(), "$controller@destroy"))
                    <div class="row" style="position: absolute; right: 0; padding: 5px; z-index: 100;">
                        <div class="col-md-12">
                            <a href="javascript:void(0);" type="button" class="btn btn-danger excluir-auto-confirma" modulo="mra_nota_fiscal/mra_produtos" modulo_id="{{$MRANfProdutos->id}}"><i class="glyphicon glyphicon-trash"></i></a>
                        </div>
                    </div>
                @endif
            @endif
            <div class="box-body" id="div_mra_produtos">
                ...
                <div size="12" class="inputbox col-md-12">
                    <div class="row">
                        <div size="12" class="inputbox col-md-12">
                            <div class="form-group">
                                {!! Form::label('','CFOP') !!}
                                {!! Form::select('cfop', \App\Http\Controllers\MRA\MRANotasFiscais::Get_options_cfop(), ($acao=='edit'?$MRANfProdutos->cfop:null), ['class' => 'form-control select_single_no_trigger bootstrap-select-st2', 'data-live-search' => 'true', "dropdown-menu-right"=>"", "id" => "input_cfop"]) !!}
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div size="3" class="inputbox col-md-3">
                            <div class="form-group">
                                {!! Form::label('','NCM') !!}
                                {!! Form::text('ncm', ($acao=='edit'?$MRANfProdutos->ncm:null), ['class' => 'form-control', "id" => "input_ncm", "maxlength"=>50]) !!}
                            </div>
                        </div>
                        <div size="3" class="inputbox col-md-3">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div size="3" class="inputbox col-md-3">
                            <div class="row" style="background-color: #f1f1f1;">
                                <div size="12" class="inputbox col-md-12" style="padding-top: 15px;">
                                    <div class="form-group">
                                        {!! Form::label('','ICMS - CST') !!}
                                        {!! Form::select('icms_cst', \App\Http\Controllers\MRA\MRANotasFiscais::Get_options_cst_icms(), ($acao=='edit'?$MRANfProdutos->icms_cst:null), ['class' => 'form-control select_single_no_trigger', 'data-live-search' => 'true', "id" => "input_icms_cst"]) !!}
                                    </div>
                                </div>
                                <div size="12" class="inputbox col-md-12">
                                    <div class="form-group">
                        ...
                        <div size="3" class="inputbox col-md-3">
                            <div class="row" style="background-color: #e3e3e3;">
                                <div size="12" class="inputbox col-md-12" style="padding-top: 15px;">
                                    <div class="form-group">
                                        {!! Form::label('','IPI - CST') !!}
                                        {!! Form::select('ipi_cst', \App\Http\Controllers\MRA\MRANotasFiscais::Get_options_cst_ipi(), ($acao=='edit'?$MRANfProdutos->ipi_cst:null), ['class' => 'form-control select_single_no_trigger', 'data-live-search' => 'true', "id" => "input_ipi_cst"]) !!}
                                    </div>
                                </div>
                                <div size="12" class="inputbox col-md-12">
                                    <div class="form-group">
                        ...
                        <div size="3" class="inputbox col-md-3">
                            <div class="row" style="background-color: #f1f1f1;">
                                <div size="12" class="inputbox col-md-12" style="padding-top: 15px;">
                                    <div class="form-group">
                                        {!! Form::label('','PIS - CST') !!}
                                        {!! Form::select('pis_cst', \App\Http\Controllers\MRA\MRANotasFiscais::Get_options_cst_pis_ou_cofins(), ($acao=='edit'?$MRANfProdutos->pis_cst:null), ['class' => 'form-control select_single_no_trigger', 'data-live-search' => 'true', "dropdown-menu-right"=>"", "id" => "input_pis_cst"]) !!}
                                    </div>
                                </div>
                                <div size="12" class="inputbox col-md-12">
                                    <div class="form-group">
                        ...
                        <div size="3" class="inputbox col-md-3">
                            <div class="row" style="background-color: #e3e3e3;">
                                <div size="12" class="inputbox col-md-12" style="padding-top: 15px;">
                                    <div class="form-group">
                                        {!! Form::label('','COFINS - CST - ') !!}
                                        {!! Form::select('cofins_cst', \App\Http\Controllers\MRA\MRANotasFiscais::Get_options_cst_pis_ou_cofins(), ($acao=='edit'?$MRANfProdutos->cofins_cst:null), ['class' => 'form-control select_single_no_trigger', 'data-live-search' => 'true', "dropdown-menu-right"=>"", "id" => "input_cofins_cst"]) !!}
                                    </div>
                                </div>
                                <div size="12" class="inputbox col-md-12">
                                    <div class="form-group">
