...
<section class="content-header Grid Pagamentos_add">
    <h1>Grid Pagamentos</h1>
    <!--@if(!$isPublic)
    <ol class="breadcrumb">
        <li><a href="{{ URL('/') }}">Home</a></li>
        <li><a href="{{ URL('/') }}/grid_pagamentos">Grid Pagamentos</a></li>
        <li class="active">Grid Pagamentos</li>
    </ol>
    @endif-->
</section>

<section class="content Grid Pagamentos_add">

<div class="box">

    {!! Form::open(['url' => "grid_pagamentos", 'method' => 'post', 'novalidate'=> true, 'enctype' => 'multipart/form-data', 'accept-charset' => 'utf-8', 'id' => 'form_add_grid_pagamentos']) !!}
