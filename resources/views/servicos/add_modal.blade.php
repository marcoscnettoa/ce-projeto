...
@endphp
<section class="content-header Serviços_add">
    <div id="myModal-success-errors" style="display:none;"></div>
    <h1>Serviços</h1>
</section>
<section class="content Serviços_add">
    <div class="box">
        {!! Form::open(['url' => "servicos", 'method' => 'post', 'novalidate'=> true, 'enctype' => 'multipart/form-data', 'accept-charset' => 'utf-8', 'id' => 'form_add_servicos','class'=>'form-modal-create form_add']) !!}
        {!! Form::hidden('modal-create-edit', 1) !!}
        <div class="box-body" id="div_servicos" style="margin-top:0; padding-top:0;">
            <div size="12" class="inputbox col-md-12">
                <div class="form-group">
                    {!! Form::label('','Serviço') !!}
                    {!! Form::text('servico', null, ['class' => 'form-control' , "id" => "input_servico", "style" => "text-transform: uppercase;", "oninput" => "this.value = this.value.toUpperCase();"]) !!}
                </div>
            </div>
            @if(0)
