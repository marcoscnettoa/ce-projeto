@php
    ...
    $td_colunas_fields      = json_decode('[{"name":"Dados do Passageiro","type":"section","disabled":false,"note":null,"value":null,"className":"DadosDoPassageiro","cleanName":"dados_do_passageiro"},{"name":"Nome","type":"text","size":"4","actions_advanced":true,"inputToLower":true,"exibeFiltros":true,"className":"Nome","cleanName":"nome"},{"name":"CPF","type":"cpf","size":"2","disabled":false,"note":null,"value":null,"class":"cpf","actions_advanced":true,"exibeFiltros":true,"className":"Cpf","cleanName":"cpf"},{"name":"E-mail","type":"email","disabled":false,"note":null,"value":null,"size":"3","actions_advanced":true,"exibeFiltros":true,"className":"EMail","cleanName":"e_mail"},{"name":"Telefone","type":"telefone","size":"2","disabled":false,"note":null,"value":null,"class":"telefone","actions_advanced":true,"exibeFiltros":true,"className":"Telefone","cleanName":"telefone"},{"name":"Telefone 2","type":"telefone","disabled":false,"note":null,"value":null,"class":"telefone","size":"2","actions_advanced":true,"exibeFiltros":true,"className":"Telefone2","cleanName":"telefone_2"},{"name":"Passaporte","type":"text","size":"2","actions_advanced":true,"exibeFiltros":true,"className":"Passaporte","cleanName":"passaporte"}]',true);
    ...
    foreach($passageiro as $key => $list){
        ...
        $quadros[$list->$kanban_field]['item'][$key]['title']     .= '
            <div class="kanban-buttons text-right">
                <button modulo="passageiro" modulo_id="'.$list->id.'" modulo_method="GET" modulo_url="passageiro/'.$list->id.'/edit" modulo_redirect="true" class="btn btn-xs btn-default kanban-btn-edit"><i class="glyphicon glyphicon-edit" title="Editar"></i></button>
                <button modulo="passageiro" modulo_id="'.$list->id.'" modulo_method="GET" modulo_url="passageiro/'.$list->id.'/copy" modulo_redirect="true" class="btn btn-xs btn-default kanban-btn-copy"><i class="glyphicon glyphicon-copy" title="Duplicar linha"></i></button>
                <button modulo="passageiro" modulo_id="'.$list->id.'" modulo_method="GET" modulo_url="passageiro/'.$list->id.'" modulo_redirect="true" class="btn btn-xs btn-default kanban-btn-view"><i class="glyphicon glyphicon-eye-open" title="Visualizar"></i></button>
                <button modulo="passageiro" modulo_id="'.$list->id.'" class="btn btn-xs btn-danger excluir-auto-confirma" style="float:none;margin: 0px;" title="Excluir"><i class="glyphicon glyphicon-trash"></i></button>
            </div>
        ';
    }
...
<div class="form-group form-group-btn-index text-right">
    @if(\App\Models\Permissions::permissaoUsuario(\Auth::user(), "$controller@store") OR $isPublic)
        <a href="{{ URL('/') }}/passageiro/create" class="btn btn-default form-group-btn-index-cadastrar"><i class="glyphicon glyphicon-plus"></i> Cadastrar</a>
    @endif
</div>
