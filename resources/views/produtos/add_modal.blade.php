...
@endphp
<section class="content-header Produtos_add">
    <div id="myModal-success-errors" style="display:none;"></div>
    <h1>Produtos</h1>
</section>
<section class="content Produtos_add">
    <div class="box">
        {!! Form::open(['url' => "produtos", 'method' => 'post', 'novalidate'=> true, 'enctype' => 'multipart/form-data', 'accept-charset' => 'utf-8', 'id' => 'form_add_produtos','class'=>'form-modal-create form_add']) !!}
        {!! Form::hidden('modal-create-edit', 1) !!}
        <div class="box-body" id="div_produtos" style="margin-top:0; padding-top:0;">
            <div size="12" class="inputbox col-md-12">
                <div class="form-group">
                    {!! Form::label('','Produto') !!}
                    {!! Form::text('produto', null, ['class' => 'form-control' , "id" => "input_produto", "style" => "text-transform: uppercase;", "oninput" => "this.value = this.value.toUpperCase();"]) !!}
                </div>
            </div>
            @if(0)
