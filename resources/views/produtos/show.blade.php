...
<section class="content-header Produtos_show">
    <h1>Produtos </h1>
    <!--@if(!$isPublic)
    <ol class="breadcrumb">
...
<section class="content Produtos_show">
    ...
    <div class="box">
        ...
        <div class="box-body">
                ...
                <div class="form-group">
                    {!! Form::label('','Produto') !!}
                    {!! Form::text('produto', $produtos->produto, ['class' => 'form-control' , "id" => "input_produto", "style" => "text-transform: uppercase;", "oninput" => "this.value = this.value.toUpperCase();",'disabled' => 'disabled',]) !!}
                </div>
            </div>
