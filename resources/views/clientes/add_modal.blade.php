...
<section class="content Clientes_add">
    <div class="box">
        {!! Form::open(['url' => "clientes", 'method' => 'post', 'novalidate'=> true, 'enctype' => 'multipart/form-data', 'accept-charset' => 'utf-8', 'id' => 'form_add_clientes','class'=>'form-modal-create form_add']) !!}
        {!! Form::hidden('modal-create-edit', 1) !!}
        <div class="box-body" id="div_clientes" style="margin-top:0; padding-top:0;">
