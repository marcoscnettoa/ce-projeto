@php
    ...
    $td_colunas_fields      = json_decode('[{"name":"Dados do Cliente","type":"section","size":"12","disabled":false,"note":null,"value":null,"className":"DadosDoCliente","cleanName":"dados_do_cliente"},{"name":"C\u00f3digo do Cliente","type":"number","size":"2","actions_advanced":true,"disabled":true,"note":null,"value":null,"conditional_color":true,"conditional_color_field":"CNPJ do Cliente","className":"CodigoDoCliente","cleanName":"codigo_do_cliente"},{"name":"CNPJ do Cliente","type":"cnpj","disabled":false,"note":null,"value":null,"class":"cnpj","size":"3","actions_advanced":true,"exibeFiltros":true,"className":"CnpjDoCliente","cleanName":"cnpj_do_cliente"},{"name":"CPF do Cliente","type":"cpf","size":"3","actions_advanced":true,"exibeFiltros":true,"className":"CpfDoCliente","cleanName":"cpf_do_cliente"},{"name":"Inscri\u00e7\u00e3o Estadual\/RG","type":"text","size":"3","className":"InscricaoEstadualRg","cleanName":"inscricao_estadual_rg"},{"name":"Nome do Cliente","type":"text","size":"7","actions_advanced":true,"exibeFiltros":true,"inputToLower":true,"className":"NomeDoCliente","cleanName":"nome_do_cliente"},{"name":"Fantasia","type":"text","size":"5","actions_advanced":true,"exibeFiltros":true,"className":"Fantasia","cleanName":"fantasia"},{"name":"E-mail","type":"text","size":"6","actions_advanced":true,"exibeFiltros":true,"className":"EMail","cleanName":"e_mail"},{"name":"Observa\u00e7\u00e3o","type":"text","size":"12","className":"Observacao","cleanName":"observacao"},{"name":"Telefone 1","type":"telefone","size":"3","whatsapp":true,"actions_advanced":true,"exibeFiltros":true,"className":"Telefone1","cleanName":"telefone_1"},{"name":"Telefone 2","type":"telefone","size":"3","className":"Telefone2","cleanName":"telefone_2"},{"name":"Endere\u00e7o do Cliente","type":"section","size":"12","disabled":false,"note":null,"value":null,"className":"EnderecoDoCliente","cleanName":"endereco_do_cliente"},{"name":"CEP do Cliente","type":"cep","size":"3","actions_advanced":true,"className":"CepDoCliente","cleanName":"cep_do_cliente"},{"name":"Endere\u00e7o","type":"text","size":"7","className":"Endereco","cleanName":"endereco"},{"name":"N\u00famero:","type":"text","size":"2","className":"Numero","cleanName":"numero_"},{"name":"Complemento","type":"text","size":"8","className":"Complemento","cleanName":"complemento"},{"name":"Bairro","type":"text","size":"4","className":"Bairro","cleanName":"bairro"},{"name":"Cidade","type":"text","size":"4","actions_advanced":true,"exibeFiltros":true,"className":"Cidade","cleanName":"cidade"},{"name":"Estado","type":"text","size":"4","className":"Estado","cleanName":"estado"},{"name":"Ponto de Refer\u00eancia","type":"text","size":"4","className":"PontoDeReferencia","cleanName":"ponto_de_referencia"},{"name":"Anexos","type":"section","disabled":false,"note":null,"value":null,"className":"Anexos","cleanName":"anexos"},{"name":"Documentos","type":"file","disabled":false,"note":null,"value":null,"actions_advanced":true,"multiple":true,"className":"Documentos","cleanName":"documentos"}]',true);
    ...
    foreach($clientes as $key => $list){
        ...
        $quadros[$list->$kanban_field]['item'][$key]['title']     .= '
            <div class="kanban-buttons text-right">
                <button modulo="clientes" modulo_id="'.$list->id.'" modulo_method="GET" modulo_url="clientes/'.$list->id.'/edit" modulo_redirect="true" class="btn btn-xs btn-default kanban-btn-edit"><i class="glyphicon glyphicon-edit" title="Editar"></i></button>
                <button modulo="clientes" modulo_id="'.$list->id.'" modulo_method="GET" modulo_url="clientes/'.$list->id.'/copy" modulo_redirect="true" class="btn btn-xs btn-default kanban-btn-copy"><i class="glyphicon glyphicon-copy" title="Duplicar linha"></i></button>
                <button modulo="clientes" modulo_id="'.$list->id.'" modulo_method="GET" modulo_url="clientes/'.$list->id.'" modulo_redirect="true" class="btn btn-xs btn-default kanban-btn-view"><i class="glyphicon glyphicon-eye-open" title="Visualizar"></i></button>
                <button modulo="clientes" modulo_id="'.$list->id.'" class="btn btn-xs btn-danger excluir-auto-confirma" style="float:none;margin: 0px;" title="Excluir"><i class="glyphicon glyphicon-trash"></i></button>
            </div>
        ';
    }
...
<div class="form-group form-group-btn-index text-right">
    @if(\App\Models\Permissions::permissaoUsuario(\Auth::user(), "$controller@store") OR $isPublic)
        <a href="{{ URL('/') }}/clientes/create" class="btn btn-default form-group-btn-index-cadastrar"><i class="glyphicon glyphicon-plus"></i> Cadastrar</a>
    @endif
</div>
