...
@endphp
<section class="content-header CadastroDeEmpresas_add">
    <div id="myModal-success-errors" style="display:none;"></div>
    <h1>Cadastro de Empresas</h1>
</section>
<section class="content Cadastro de Empresas_add">
<div class="box">
    {!! Form::open(['url' => "cadastro_de_empresas", 'method' => 'post', 'novalidate'=> true, 'enctype' => 'multipart/form-data', 'accept-charset' => 'utf-8', 'id' => 'form_add_cadastro_de_empresas','class'=>'form-modal-create form_add']) !!}
        {!! Form::hidden('modal-create-edit', 1) !!}
        <div class="box-body" id="div_cadastro_de_empresas" style="margin-top:0; padding-top:0;">
