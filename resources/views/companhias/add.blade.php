...
<div class="box">
    ...
    {!! Form::open(['url' => "companhias", 'method' => 'post', 'novalidate'=> true, 'enctype' => 'multipart/form-data', 'accept-charset' => 'utf-8', 'id' => 'form_add_companhias']) !!}
