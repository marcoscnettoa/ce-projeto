...
<section class="content-header Formas de Pagamentos_add">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Formas de Pagamentos</li>
    </ol>
    @endif-->
</section>
...
<div class="box">
    ...
    {!! Form::open(['url' => "formas_de_pagamentos", 'method' => 'post', 'novalidate'=> true, 'enctype' => 'multipart/form-data', 'accept-charset' => 'utf-8', 'id' => 'form_add_formas_de_pagamentos']) !!}
