@php
    ...
    $td_colunas_fields      = json_decode('[{"name":"BANDEIRA DO CART\u00c3O:","type":"section","disabled":false,"note":null,"value":null,"className":"BandeiraDoCartao","cleanName":"bandeira_do_cartao_"},{"name":"Visa:","type":"checkbox","disabled":false,"note":null,"value":null,"size":"2","actions_advanced":true,"exibeFiltros":true,"className":"Visa","cleanName":"visa_"},{"name":"Mastercard:","type":"checkbox","disabled":false,"note":null,"value":null,"size":"2","actions_advanced":true,"exibeFiltros":true,"className":"Mastercard","cleanName":"mastercard_"},{"name":"Diners:","type":"checkbox","disabled":false,"note":null,"value":null,"size":"2","actions_advanced":true,"exibeFiltros":true,"className":"Diners","cleanName":"diners_"},{"name":"Outros","type":"checkbox","disabled":false,"note":null,"value":null,"size":"2","actions_advanced":true,"exibeFiltros":true,"className":"Outros","cleanName":"outros"},{"name":"DADOS DO CART\u00c3O:","type":"section","disabled":false,"note":null,"value":null,"className":"DadosDoCartao","cleanName":"dados_do_cartao_"},{"name":"N\u00famero do Cart\u00e3o:","type":"text","disabled":false,"note":null,"value":null,"size":"3","sum":false,"actions_advanced":true,"class":"text","className":"NumeroDoCartao","cleanName":"numero_do_cartao_"},{"name":"C\u00f3digo de Verifica\u00e7\u00e3o:","type":"number","disabled":false,"note":null,"value":null,"size":"2","className":"CodigoDeVerificacao","cleanName":"codigo_de_verificacao_"},{"name":"Data de Validade Cart\u00e3o:","type":"data","disabled":false,"note":null,"value":null,"class":"data","size":"3","className":"DataDeValidadeCartao","cleanName":"data_de_validade_cartao_"},{"name":"Nome do Titular:","type":"text","actions_advanced":true,"exibeFiltros":true,"inputToLower":true,"className":"NomeDoTitular","cleanName":"nome_do_titular_"},{"name":"CPF:","type":"text","disabled":false,"note":null,"value":null,"size":"3","class":"text","actions_advanced":true,"exibeFiltros":true,"className":"Cpf","cleanName":"cpf_"},{"name":"Nro do Telefone do Respons\u00e1vel:","type":"telefone","disabled":false,"note":null,"value":null,"class":"telefone","size":"3","className":"NroDoTelefoneDoResponsavel","cleanName":"nro_do_telefone_do_respo"},{"name":"VALORES E CONDI\u00c7\u00d5ES:","type":"section","disabled":false,"note":null,"value":null,"className":"ValoresECondicoes","cleanName":"valores_e_condicoes_"},{"name":"Valor Total:","type":"money","disabled":false,"note":null,"value":null,"class":"money","size":"3","className":"ValorTotal","cleanName":"valor_total_"},{"name":"Nro de Parcelas:","type":"number","disabled":false,"note":null,"value":null,"size":"2","className":"NroDeParcelas","cleanName":"nro_de_parcelas_"},{"name":"Valor da Parcela:","type":"calculo","disabled":false,"note":null,"value":null,"class":"calculo","expression":"COL13 \/ COL14","decimals":2,"size":"2","className":"ValorDaParcela","cleanName":"valor_da_parcela_"},{"name":"IMPORTANTE:","type":"section","disabled":false,"note":null,"value":null,"className":"Importante","cleanName":"importante_"},{"name":"Esta autoriza\u00e7\u00e3o destina-se ao pagamento em nome de:","type":"text","size":"4","className":"EstaAutorizacaoDestinaSeAoPagamentoEmNomeDe","cleanName":"esta_autorizacao_destina"},{"name":"Nro. Telefone Passageiro:","type":"telefone","disabled":false,"note":null,"value":null,"class":"telefone","size":"3","className":"NroTelefonePassageiro","cleanName":"nro_telefone_passageiro_"},{"name":"Cia A\u00e9rea:","type":"text","size":"2","className":"CiaAerea","cleanName":"cia_aerea_"},{"name":"Data de Embarque:","type":"data","disabled":false,"note":null,"value":null,"class":"data","size":"3","className":"DataDeEmbarque","cleanName":"data_de_embarque_"},{"name":"Destino:","type":"text","size":"6","className":"Destino","cleanName":"destino_"}]',true);
    ...
    foreach($ccf_cartao_de_credito as $key => $list){
        ...
        $quadros[$list->$kanban_field]['item'][$key]['title']     .= '
            <div class="kanban-buttons text-right">
                <button modulo="ccf_cartao_de_credito" modulo_id="'.$list->id.'" modulo_method="GET" modulo_url="ccf_cartao_de_credito/'.$list->id.'/edit" modulo_redirect="true" class="btn btn-xs btn-default kanban-btn-edit"><i class="glyphicon glyphicon-edit" title="Editar"></i></button>
                <button modulo="ccf_cartao_de_credito" modulo_id="'.$list->id.'" modulo_method="GET" modulo_url="ccf_cartao_de_credito/'.$list->id.'/copy" modulo_redirect="true" class="btn btn-xs btn-default kanban-btn-copy"><i class="glyphicon glyphicon-copy" title="Duplicar linha"></i></button>
                <button modulo="ccf_cartao_de_credito" modulo_id="'.$list->id.'" modulo_method="GET" modulo_url="ccf_cartao_de_credito/'.$list->id.'" modulo_redirect="true" class="btn btn-xs btn-default kanban-btn-view"><i class="glyphicon glyphicon-eye-open" title="Visualizar"></i></button>
                <button modulo="ccf_cartao_de_credito" modulo_id="'.$list->id.'" class="btn btn-xs btn-danger excluir-auto-confirma" style="float:none;margin: 0px;" title="Excluir"><i class="glyphicon glyphicon-trash"></i></button>
            </div>
        ';
    }
...
<div class="form-group form-group-btn-index text-right">
    @if(\App\Models\Permissions::permissaoUsuario(\Auth::user(), "$controller@store") OR $isPublic)
        <a href="{{ URL('/') }}/ccf_cartao_de_credito/create" class="btn btn-default form-group-btn-index-cadastrar"><i class="glyphicon glyphicon-plus"></i> Cadastrar</a>
    @endif
</div>
        ...
        var kanban1 = new jKanban({
            ...
            dropEl           : function (el, target, source, sibling) {
                ...
                $.ajax({
                    ...
                    type: 'POST',
                    async: false,
                    url: base+'/ccf_cartao_de_credito/'+item_id,
                    data: data,
                    success: function(d){
                        if(d.ok != undefined){
                            ajax_return = true;
