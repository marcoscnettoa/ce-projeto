@php
    ...
    $td_colunas_fields      = json_decode('[{"name":"N\u00b0 da Fatura","type":"text","actions_advanced":true,"alias":null,"size":"3","disabled":true,"exibeFiltros":true,"className":"NDaFatura","cleanName":"n_da_fatura"},{"name":"Data da Fatura","type":"date","size":"4","disabled":false,"note":null,"value":null,"class":"date","actions_advanced":true,"exibeFiltros":true,"className":"DataDaFatura","cleanName":"data_da_fatura"},{"name":"Data de Vencimento","type":"date","size":"4","disabled":false,"note":null,"value":null,"class":"date","actions_advanced":true,"exibeFiltros":true,"className":"DataDeVencimento","cleanName":"data_de_vencimento"},{"name":"Lan\u00e7amento","type":"section","disabled":false,"note":null,"value":null,"actions_advanced":false,"size":"12","className":"Lancamento","cleanName":"lancamento"},{"name":"Cliente","type":"select","size":"4","disabled":false,"note":null,"value":null,"class":"datetime","relationship":"Clientes","relationship_reference":"Nome do Cliente","checkSubrelationship":false,"actions_advanced":true,"exibeFiltros":true,"relationshipReferenceClassName":"Clientes","relationshipReferenceCleanName":"nome_do_cliente","className":"Cliente","cleanName":"cliente"},{"name":"Data Inicial","type":"date","size":"4","disabled":false,"note":null,"value":null,"class":"date","actions_advanced":true,"exibeFiltros":true,"className":"DataInicial","cleanName":"data_inicial"},{"name":"Data Final","type":"date","disabled":false,"note":null,"value":null,"class":"date","size":"4","actions_advanced":true,"exibeFiltros":true,"className":"DataFinal","cleanName":"data_final"},{"name":"Template","type":"select","disabled":false,"note":null,"value":null,"relationship":"Templates","relationship_reference":"Nome do Template","actions_advanced":true,"hidden_view":true,"relationshipReferenceClassName":"Templates","relationshipReferenceCleanName":"nome_do_template","className":"Template","cleanName":"template"}]',true);
    ...
    foreach($faturamento as $key => $list){
        ...
        $quadros[$list->$kanban_field]['item'][$key]['title']     .= '
            <div class="kanban-buttons text-right">
                <button modulo="faturamento" modulo_id="'.$list->id.'" modulo_method="GET" modulo_url="faturamento/'.$list->id.'/edit" modulo_redirect="true" class="btn btn-xs btn-default kanban-btn-edit"><i class="glyphicon glyphicon-edit" title="Editar"></i></button>
                <button modulo="faturamento" modulo_id="'.$list->id.'" modulo_method="GET" modulo_url="faturamento/'.$list->id.'/copy" modulo_redirect="true" class="btn btn-xs btn-default kanban-btn-copy"><i class="glyphicon glyphicon-copy" title="Duplicar linha"></i></button>
                <button modulo="faturamento" modulo_id="'.$list->id.'" modulo_method="GET" modulo_url="faturamento/'.$list->id.'" modulo_redirect="true" class="btn btn-xs btn-default kanban-btn-view"><i class="glyphicon glyphicon-eye-open" title="Visualizar"></i></button>
                <button modulo="faturamento" modulo_id="'.$list->id.'" class="btn btn-xs btn-danger excluir-auto-confirma" style="float:none;margin: 0px;" title="Excluir"><i class="glyphicon glyphicon-trash"></i></button>
            </div>
        ';
    }
...
<div class="form-group form-group-btn-index text-right">
    @if(\App\Models\Permissions::permissaoUsuario(\Auth::user(), "$controller@store") OR $isPublic)
        <a href="{{ URL('/') }}/faturamento/create" class="btn btn-default form-group-btn-index-cadastrar"><i class="glyphicon glyphicon-plus"></i> Cadastrar</a>
    @endif
</div>
