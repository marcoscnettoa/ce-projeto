...
<section class="content-header Faturamento_add">
    <h1>Faturamento</h1>
    <!--@if(!$isPublic)
    <ol class="breadcrumb">
...
{!! Form::open(['url' => "faturamento", 'method' => 'post', 'novalidate'=> true, 'enctype' => 'multipart/form-data', 'accept-charset' => 'utf-8', 'id' => 'form_add_faturamento']) !!}
    <section class="content Faturamento_add">
        <div class="box">
            <div class="box-body" id="div_faturamento">
                <div size="3" class="inputbox col-md-3">
                    <div class="form-group">
                        {!! Form::label('','N° da Fatura') !!}
                        {!! Form::text('n_da_fatura', null, ['class' => 'form-control' , "id" => "input_n_da_fatura",'disabled' => 'disabled',]) !!}
                    </div>
                </div>
                <div size="4" class="inputbox col-md-4">
                    <div class="form-group">
                        {!! Form::label('','Data da Fatura') !!}
                        {!! Form::text('data_da_fatura', null, ['autocomplete' =>'off', 'class' => 'form-control componenteData' , "id" => "input_data_da_fatura"]) !!}
                    </div>
                </div>
                <div size="4" class="inputbox col-md-4">
                    <div class="form-group">
                        {!! Form::label('','Data de Vencimento') !!}
                        {!! Form::text('data_de_vencimento', null, ['autocomplete' =>'off', 'class' => 'form-control componenteData' , "id" => "input_data_de_vencimento"]) !!}
                    </div>
                </div>
                ...
                {{--<div size="4" class="inputbox col-md-4">
                    <div class="form-group">
                        ...
                        {!! Form::text('data_inicial', null, ['autocomplete' =>'off', 'class' => 'form-control componenteData' , "id" => "input_data_inicial"]) !!}
                    </div>
                </div>
                <div size="4" class="inputbox col-md-4">
                    <div class="form-group">
                        {!! Form::label('','Data Final') !!}
                        {!! Form::text('data_final', null, ['autocomplete' =>'off', 'class' => 'form-control componenteData' , "id" => "input_data_final"]) !!}
                    </div>
                </div>--}}
                {{--<div size="12" class="inputbox col-md-12">
                    <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table id="table_vendas" class="table-st1 table-striped table-bordered stripe " style="width:100%;">
                                <thead>
                                <tr>
                                ...
                                <tbody>
                                    <tr><td colspan="15" class="text-center">Nenhum resultado encontrado!</td></tr>
                                </tbody>
                            </table>
                        </div>
                    </div>
