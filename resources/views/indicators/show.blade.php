            ...
            <div class="col-md-4">
                <div class="form-group">
                    <div class="input text">
                        ...
                        {!! Form::text('name', $indicators->name, ['class' => 'form-control', 'placeholder'=>'Ex: Total de usuários', 'required'=> 'required', 'disabled' => true]) !!}
                    </div>
                </div>
            </div>
            <div class="col-md-2">
                <div class="form-group">
                    <div class="input text">
                        ...
                        <select name="glyphicon" id="glyphicon" class="selectpicker form-control" disabled="disabled">
                            <option data-icon="glyphicon {{$indicators->glyphicon}}" value="glyphicon {{$indicators->glyphicon}}" selected="selected"></option>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <div class="input text">
                        ...
                        {!! Form::textarea('query', $indicators->query, ['class' => 'form-control', 'rows' => 2, 'placeholder'=>'Ex: SELECT count(*) FROM users;', 'required'=> 'required', 'disabled' => true]) !!}
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <div class="input text">
                        ...
                        {!! Form::textarea('description', $indicators->description, ['class' => 'form-control', 'rows' => 2, 'disabled' => true]) !!}
                    </div>
                </div>
            </div>
        </div>
