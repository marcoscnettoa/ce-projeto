...
<h3 class="box-title" style="margin-left: 15px;">Editar indicador</h3>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        <div class="input text">
                            ...
                            {!! Form::text('name', $indicators->name, ['class' => 'form-control', 'placeholder'=>'Ex: Total de usuários', 'required'=> 'required']) !!}
                        </div>
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group">
                        <div class="input text">
                            ...
                            <select name="glyphicon" id="glyphicon" class="selectpicker form-control">
                                <option data-icon="{{$indicators->glyphicon}}" value="{{$indicators->glyphicon}}" selected="selected"></option>
                ...
                <div class="col-md-1">
                    <div class="form-group">
                        <div class="input text">
                            {!! Form::label('Cor') !!}
                            <input class="form-control" name="color" type="color" value="{{$indicators->color}}">
                        </div>
                    </div>
                </div>
                <div class="col-md-1">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <div class="input text">
                            ...
                            {!! Form::textarea('query', $indicators->query, ['class' => 'form-control', 'rows' => 2, 'placeholder'=>'Ex: SELECT count(*) FROM users;', 'required'=> 'required']) !!}
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <div class="input text">
                            ...
                            {!! Form::textarea('description', $indicators->description, ['class' => 'form-control', 'rows' => 2]) !!}
                        </div>
                    </div>
                </div>
            </div>
