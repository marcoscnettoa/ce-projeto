...
@endphp
<section class="content-header Trechos_add">
    <div id="myModal-success-errors" style="display:none;"></div>
    <h1>Trechos</h1>
</section>
<section class="content Trechos_add">
<div class="box">
    {!! Form::open(['url' => "trechos", 'method' => 'post', 'novalidate'=> true, 'enctype' => 'multipart/form-data', 'accept-charset' => 'utf-8', 'id' => 'form_add_trechos','class'=>'form-modal-create form_add']) !!}
    {!! Form::hidden('modal-create-edit', 1) !!}
    <div class="box-body" id="div_trechos" style="margin-top:0; padding-top:0;">
        <div size="12" class="inputbox col-md-12">
            <div class="form-group">
                {!! Form::label('','Trechos') !!}
                {!! Form::text('trechos', null, ['class' => 'form-control' , "id" => "input_trechos", "style" => "text-transform: uppercase;", "oninput" => "this.value = this.value.toUpperCase();"]) !!}
            </div>
        </div>
        @if(0)
