...
<h3 class="box-title" style="margin-left: 15px;">Cadastrar relatório</h3>
        ...
        <div class="box-body">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <div class="input text">
                            ...
                            {!! Form::textarea('query', null, ['class' => 'form-control', 'required'=> 'required', 'placeholder'=>'Ex: SELECT * FROM users;', 'required'=> 'required']) !!}
                        </div>
                    </div>
                </div>
                ...
                <div size="3" class="inputbox col-md-3">
                    <div class="form-group">
                        {!! Form::label('','Tamanho') !!}
                        {!! Form::select('size', \App\Models\Reports::Get_options_tipo_size(), null, ['class' => 'form-control  select_single ', 'data-sub' => '', 'data-live-search' => 'true', 'id' => 'input_size' ]) !!}
                    </div>
                </div>
                ...
                <div id="box_size_height" class="col-md-3" style="display:none;">
                    <div class="form-group">
                        <div class="input text">
                            {!! Form::label('', 'Altura') !!}
                            {!! Form::number('size_height', null, ['class' => 'form-control', 'placeholder'=>'0', 'min'=>0]) !!}
                        </div>
                    </div>
                </div>
                ...
                <div id="box_size_width" class="col-md-3" style="display:none;">
                    <div class="form-group">
                        <div class="input text">
                            {!! Form::label('', 'Largura') !!}
                            {!! Form::number('size_width', null, ['class' => 'form-control', 'placeholder'=>'0', 'min'=>0]) !!}
                        </div>
                    </div>
                </div>
                {{-- - # --}}
