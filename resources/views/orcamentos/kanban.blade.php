@php
    ...
    $td_colunas_fields      = json_decode('[{"name":"N\u00famero","type":"text","size":"2","actions_advanced":true,"exibeFiltros":true,"className":"Numero","cleanName":"numero"},{"name":"Data","type":"date","disabled":false,"note":null,"value":null,"class":"date","size":"2","buttonGlyphicon":"glyphicon glyphicon-calendar","actions_advanced":true,"exibeFiltros":true,"conditional":false,"operatorfield":false,"aliasBetween":"&","className":"Data","cleanName":"data"},{"name":"Clilente","type":"text","size":"5","actions_advanced":true,"exibeFiltros":true,"className":"Clilente","cleanName":"clilente"},{"name":"Vendedor","type":"text","size":"3","actions_advanced":true,"exibeFiltros":true,"className":"Vendedor","cleanName":"vendedor"},{"name":"Produto","type":"text","actions_advanced":true,"exibeFiltros":true,"className":"Produto","cleanName":"produto"},{"name":"Per\u00edodo de","type":"date","disabled":false,"note":null,"value":null,"class":"date","size":"2","buttonGlyphicon":"glyphicon glyphicon-calendar","className":"PeriodoDe","cleanName":"periodo_de"},{"name":"A","type":"date","disabled":false,"note":null,"value":null,"class":"date","size":"2","className":"A","cleanName":"a"},{"name":"Viajantes","type":"text","size":"4","className":"Viajantes","cleanName":"viajantes"},{"name":"Crian\u00e7as","type":"text","size":"2","className":"Criancas","cleanName":"criancas"},{"name":"Idade","type":"text","size":"2","className":"Idade","cleanName":"idade"},{"name":"MALAS DESPACHADAS","type":"section","disabled":false,"note":null,"value":null,"className":"MalasDespachadas","cleanName":"malas_despachadas"},{"name":"Inclui","type":"text","size":"2","value":null,"className":"Inclui","cleanName":"inclui"},{"name":"N\u00e3o inclui","type":"text","size":"2","className":"NaoInclui","cleanName":"nao_inclui"},{"name":"VALOR POR PASSAGEIRO","type":"section","disabled":false,"note":null,"value":null,"className":"ValorPorPassageiro","cleanName":"valor_por_passageiro"},{"name":"Passageiros","type":"text","size":"3","className":"Passageiros","cleanName":"passageiros"},{"name":"Quantidade","type":"number","size":"2","disabled":false,"note":null,"value":null,"className":"Quantidade","cleanName":"quantidade"},{"name":"Valor por pessoa","type":"money","size":"3","disabled":false,"note":null,"value":null,"class":"money","className":"ValorPorPessoa","cleanName":"valor_por_pessoa"},{"name":"Valor total","type":"money","disabled":false,"note":null,"value":null,"class":"money","size":"3","className":"ValorTotal","cleanName":"valor_total"},{"name":"OUTROS SERVI\u00c7OS","type":"section","disabled":false,"note":null,"value":null,"className":"OutrosServicos","cleanName":"outros_servicos"}]',true);
    ...
    foreach($orcamentos as $key => $list){
        ...
        $quadros[$list->$kanban_field]['item'][$key]['title']     .= '
            <div class="kanban-buttons text-right">
                <button modulo="orcamentos" modulo_id="'.$list->id.'" modulo_method="GET" modulo_url="orcamentos/'.$list->id.'/edit" modulo_redirect="true" class="btn btn-xs btn-default kanban-btn-edit"><i class="glyphicon glyphicon-edit" title="Editar"></i></button>
                <button modulo="orcamentos" modulo_id="'.$list->id.'" modulo_method="GET" modulo_url="orcamentos/'.$list->id.'/copy" modulo_redirect="true" class="btn btn-xs btn-default kanban-btn-copy"><i class="glyphicon glyphicon-copy" title="Duplicar linha"></i></button>
                <button modulo="orcamentos" modulo_id="'.$list->id.'" modulo_method="GET" modulo_url="orcamentos/'.$list->id.'" modulo_redirect="true" class="btn btn-xs btn-default kanban-btn-view"><i class="glyphicon glyphicon-eye-open" title="Visualizar"></i></button>
                <button modulo="orcamentos" modulo_id="'.$list->id.'" class="btn btn-xs btn-danger excluir-auto-confirma" style="float:none;margin: 0px;" title="Excluir"><i class="glyphicon glyphicon-trash"></i></button>
            </div>
        ';
    }
...
<div class="form-group form-group-btn-index text-right">
    @if(\App\Models\Permissions::permissaoUsuario(\Auth::user(), "$controller@store") OR $isPublic)
        <a href="{{ URL('/') }}/orcamentos/create" class="btn btn-default form-group-btn-index-cadastrar"><i class="glyphicon glyphicon-plus"></i> Cadastrar</a>
    @endif
</div>
