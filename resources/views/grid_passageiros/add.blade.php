...
<section class="content-header Grid Passageiros_add">
    <h1>Grid Passageiros</h1>
    <!--@if(!$isPublic)
    <ol class="breadcrumb">
        <li><a href="{{ URL('/') }}">Home</a></li>
        <li><a href="{{ URL('/') }}/grid_passageiros">Grid Passageiros</a></li>
        <li class="active">Grid Passageiros</li>
    </ol>
    @endif-->
</section>

<section class="content Grid Passageiros_add">

<div class="box">

    {!! Form::open(['url' => "grid_passageiros", 'method' => 'post', 'novalidate'=> true, 'enctype' => 'multipart/form-data', 'accept-charset' => 'utf-8', 'id' => 'form_add_grid_passageiros']) !!}
        ...
        <div class="box-body" id="div_grid_passageiros">
            ...
            <div size="3" class="inputbox col-md-3">
                <div class="form-group">
                    ...
                    {!! Form::select('passageiros', $passageiro_nome, null, ['class' => 'form-control  select_relationship ', 'data-sub' => '', 'data-live-search' => 'true',  'data-none-selected-text' => true, 'controller' => 'passageiro' , "id" => "input_passageiros", "style" => "text-transform: uppercase;", "oninput" => "this.value = this.value.toUpperCase();"]) !!}
                </div>
            </div>
